...
#    Updated: 2026/02/16 16:59:13 by shierro          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC=main.c ft_allocs.c ft_frees.c ft_swap.c ft_validations.c ft_push.c ft_rotate.c ft_rotate_reverse.c\
	...
	ft_bench.c ft_split_aux.c ft_merge_sort.c ft_range_sort.c ft_three_sort.c ft_selection_sort.c ft_print_disorder.c
