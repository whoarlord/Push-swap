...
#    Updated: 2026/02/10 13:55:30 by iarrien-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC=main.c ft_allocs.c ft_frees.c ft_swap.c ft_validations.c ft_push.c ft_rotate.c ft_rotate_reverse.c\
	ft_utils.c ft_bubble.c ft_radix_sort.c ft_manipulate_arrays.c ft_borders.c ft_turk_sort.c ft_turk_utils.c\
	ft_bench.c ft_split_aux.c ft_range_sort.c
OBJ=$(SRC:.c=.o)
